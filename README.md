...
as [examples/advanced/1.0.0.json](https://github.com/DiamondLightSource/ulims-json-schemas/blob/main/schemas/examples/advanced/1.0.0.json?raw=1).
...
a [simpler view](https://github.com/DiamondLightSource/ulims-json-schemas/blob/main/schemas/examples/advanced/current.json?raw=1)
